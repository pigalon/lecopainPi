<search-order>
    <div class="form-group">
        <select onchange={ load_orders } class="form-control" name="period" id="period" ref="period" style="width: 12rem; display:inline-block">
    ...
    <script>
    	...
    	/*******************************************/
		load_orders(){
            var order_url = '/seller/api/orders';
        ...
        show_order(order_id){
            return function(e) {
                ...
                location = "/seller/orders/"+order_id;
            }
		}
