...
def home():
    ...
    orders_nb = 0#orderService.count_by_seller(seller_id=seller.id)
    products_nb = 0#productService(seller_id=seller.id)
    return render_template('/seller/base.html', orders_nb=orders_nb, seller_id=seller.id)
