...
class ProductManager():
    ...
    def update_product(self, form, product):
        productForm = Product(name=form.name.data, price=form.price.data, status=form.status.data, vendor_id=int(
            form.vendor_id.data), description=form.description.data)
